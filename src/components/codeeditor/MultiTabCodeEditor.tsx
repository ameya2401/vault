    ...
    <div className="flex flex-col h-full bg-white dark:bg-black rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
      ...
      <div className="flex bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 overflow-x-auto">
        {openFiles.map((file) => (
          <div
            key={file.id}
            className={`flex items-center px-4 py-3 cursor-pointer border-r border-gray-200 dark:border-gray-800 relative group min-w-[120px] ${activeFileId === file.id
          ...
          >
            ...
            <button
              ...
              className={`opacity-0 group-hover:opacity-100 rounded-full p-1 transition-opacity ${activeFileId === file.id ? 'hover:bg-gray-300 dark:hover:bg-gray-700' : 'hover:bg-gray-200 dark:hover:bg-gray-800'
                }`}
            >
              <X size={14} />
            </button>
        ...
        <div style={{ height: '100%', border: '1px solid #e5e7eb' }} className="dark:border-gray-800 rounded-lg overflow-hidden">
          <Editor
            ...
            options={{
              ...
              // Enable suggestions but disable validation and error markers
              ...
              // Remove all error/warning indicators
              glyphMargin: false,
